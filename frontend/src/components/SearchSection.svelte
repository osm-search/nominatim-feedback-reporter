...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a
      class="nav-link"
      class:active={!bStructuredSearch}
      data-bs-toggle="tab"
      href="#simple">Simple</a
    >
  </li>
  <li class="nav-item">
    <a
...
<details id="searchAdvancedOptions">
  ...
  <ul>
    <li>
      <div class="form-check form-check-inline">
        ...
        <input
          ...
          id="use_viewbox"
          checked={api_request_params.viewbox}
          on:change={reset_viewbox}
        />
      </div>
    </li>
    ...
    <li>
      <div class="form-check form-check-inline">
        <label class="form-check-label" for="option_bounded"
          >bounded to viewbox</label
        >
        <input
          type="checkbox"
          class="form-check-input api-param-setting"
          id="option_bounded"
          checked={!!api_request_params.bounded}
          on:change={set_bounded}
        />
      </div>
    </li>
    ...
    <li>
      <div class="form-check form-check-inline">
        <label class="form-check-label" for="option_dedupe"
          >deduplicate results</label
        >
        <input
          type="checkbox"
          class="form-check-input api-param-setting"
          id="option_dedupe"
          checked={!!api_request_params.dedupe}
    ...
    <li>
      ...
      <input
        type="number"
        class="form-control form-control-sm d-inline w-auto api-param-setting"
        data-api-param="polygon_threshold"
        id="option_polygon_threshold"
        min="0.0"
        max="1.0"
        step="0.001"
        value={api_request_params.polygon_threshold || ""}
